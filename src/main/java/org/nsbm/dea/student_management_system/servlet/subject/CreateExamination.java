...
import org.nsbm.dea.student_management_system.model.subject.CreateExaminationRequest;
...
@WebServlet("/api/subject/create-examination")
public class CreateExamination extends HttpServlet {
  @Override
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    Gson gson = new Gson();
    CreateExaminationRequest createExamination = gson.fromJson(reader, CreateExaminationRequest.class);
    reader.close();

    ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
    Validator validator = factory.getValidator();

    Set<ConstraintViolation<CreateExaminationRequest>> violations = validator.validate(createExamination);
    ...
    try {
      SubjectDAO.createExamination(user.getId(), createExamination.getSubject_id(), createExamination.getName(),
          createExamination.getDate());

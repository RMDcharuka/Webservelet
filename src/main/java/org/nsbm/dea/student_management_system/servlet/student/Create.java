...
import org.nsbm.dea.student_management_system.dao.StudentDAO;
...
import org.nsbm.dea.student_management_system.model.student.CreateStudentRequest;
...
public class Create extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    Gson gson = new Gson();
    CreateStudentRequest create = gson.fromJson(reader, CreateStudentRequest.class);
    reader.close();

    ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
    Validator validator = factory.getValidator();

    Set<ConstraintViolation<CreateStudentRequest>> violations = validator.validate(create);
    ...
    try {
      StudentDAO.create(user.getId(), create.getName(), create.getEmail(), create.getAddress(),
          create.getMobile_number());

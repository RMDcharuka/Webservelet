...
import org.nsbm.dea.student_management_system.model.subject.CreateSubjectRequest;
...
public class Create extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    Gson gson = new Gson();
    CreateSubjectRequest create = gson.fromJson(reader, CreateSubjectRequest.class);
    reader.close();

    ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
    Validator validator = factory.getValidator();

    Set<ConstraintViolation<CreateSubjectRequest>> violations = validator.validate(create);
    ...
    try {
      SubjectDAO.create(user.getId(), create.getName(), create.getSlug(), create.getTotalSessions());

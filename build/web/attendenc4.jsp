<%-- 
    Document   : attendenc4
    Created on : May 8, 2025, 11:05:30 AM
    Author     : user
--%>
...
<body>
    ...
    <ul>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-content">
            ...
            <li><a href="recode4.jsp">Softwar Engineering</a></li>
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-content">
            ...
            <li><a href="attendenc4.jsp">Softwar Engineering</a></li>
        </ul>
      </li>
  ...
  <main class="main-content">
    <header class="topbar">
      <h1>Software Engineering Attendance</h1>
    </header>
